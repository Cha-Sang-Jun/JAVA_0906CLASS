...
//     예시: *specialNumber* -> 특수문자가 들어갔으므로 에러발생.
//  2. 자바의 이름은 숫자로 시작할 수 없다.
//     예시: 1Number, 2Number -> 숫자로 이름 시작x --> Number1, Number2 가능
//  3. 자바에서 사용되는 50여가지의 예약어(=keyword)와 일치하는 이름은 사용할 수 없다.
//     예시: public 이라는 단어는 예약어이므로 만약 해당하는 뜻을 가진 이름을 지어 줄 때에는
//          동의어를 사용하거나 뒤에 단어를 더 붙여서 변형시켜 사용해야함.
...
// 뱀 표기법이란, 모든 철자를 대문자로 표시해야 하는 경우,
