...
insert into phoneinfo_basic values (1, '손흥민', '010-0000-0000', 'son@gmail.com', 'LONDON', sysdate);
-- 데이터를 반복해서 입력할때 pk인 id는 중복되면 안된다.
insert into phoneinfo_basic values (1, '이강인', '010-9999-0000', 'lee@gmail.com', 'LONDON', sysdate);
