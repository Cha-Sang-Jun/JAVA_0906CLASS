...
--(12) 도서의가격(Book 테이블)과 판매가격(Orders 테이블)의 차이가 가장 많은 주문 (x)
select o.orderid, o.custid, o.bookid, o.saleprice, b.bookname, b.bookid, b.publisher, b.price
...
-- (13) 도서의판매액평균보다자신의구매액평균이더높은고객의이름 (x)
select c.name
...
where o.custid = c.custid and o.bookid = b.bookid and b.publisher in
    ...
    where o.custid = c.custid and o.bookid = b.bookid and name = '박지성') and name != '박지성';
