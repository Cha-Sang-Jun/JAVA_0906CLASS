...
function getWeather(lat, lng) {
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lng}&appid=f25a266c07e9c4b842b6386b1068e10a&units=metric`
  )
    ...
    .then(function (json) { 
      ...
      weather.innerText = `현재온도 :  ${temp}  현재 지역 : ${place}`;
    });
}
