...
<body>
	...
	<form method="post" enctype="multipart/form-data" action="/hgs/join">
		<c:if test="${not empty emailType.snsType}">
			<input type="email" id="snsId" name="snsId" autocomplete="username"
				value="${emailType.email}" placeholder="이메일을 입력해주세요 . *">
			<br>
		...
		<input type="password" id="password1" name="password1"
			autocomplete="new-password" placeholder="패스워드를 입력해주세요 . *"><br>
